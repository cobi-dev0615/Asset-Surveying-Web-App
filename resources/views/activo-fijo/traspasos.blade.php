...
<div class="page-header">
    <h2>Traspasos de Activos</h2>
</div>

<div class="card">
    <div class="card-header">
        <span>{{ $traspasos->total() }} traspasos</span>
    </div>
        ...
        <div class="toolbar" style="padding:1rem 1.5rem;">
            <div class="toolbar-left">
                <form method="GET" style="display:flex; gap:0.5rem; flex:1;">
                    ...
                    @if(request('buscar'))
                        <a href="{{ route('traspasos.index') }}" class="btn btn-ghost btn-sm">Limpiar</a>
                    @endif
                </form>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="6" class="table-empty">
                            ...
                            <div>No se encontraron traspasos</div>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
