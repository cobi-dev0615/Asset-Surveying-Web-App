...
<div class="page-header">
    <h2>Órdenes de Transferencia Recibidas</h2>
</div>

<div class="card">
    <div class="card-header">
        <span>{{ $traspasos->total() }} transferencias recibidas</span>
    </div>
            ...
            <div class="toolbar-left">
                <form method="GET" style="display:flex; gap:0.5rem; flex:1; flex-wrap:wrap;">
                    ...
                    @if(request()->hasAny(['buscar', 'sucursal_id']))
                        <a href="{{ route('transferencias.recibidas') }}" class="btn btn-ghost btn-sm">Limpiar</a>
                    @endif
                </form>
            </div>
        </div>
